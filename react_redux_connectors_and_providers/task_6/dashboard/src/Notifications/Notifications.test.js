...
describe("<Notifications />", () => {
  ...
  describe("Notifications without listNotifications or empty listNotifications", () => {
    ...
    it.skip("Notifications renders Notification Item correct with empty listNotifications", () => {
    ...
    it.skip("Notifications renders Notification Item correct without listNotifications", () => {
      const wrapper = mount(<Notifications displayDrawer />);
      wrapper.update();
      const listItems = wrapper.find("NotificationItem");
      expect(listItems).toHaveLength(1);
